...
export RHDH_HELM_REPO ?= https://raw.githubusercontent.com/rhdh-bot/openshift-helm-charts/rhdh-1.5-rhel-9/installation
...
export RHDH_OLM_INDEX_IMAGE ?= quay.io/rhdh/iib:1.5-v$(shell oc version -o json | jq -r '.openshiftVersion' | sed -r -e "s,([0-9]+\.[0-9]+)\..+,\1,")-x86_64
