...
wait_to_exist() {
  ...
  interval=10s
  log_info "Waiting for $description to exist for up to $initial_timeout seconds..."
...
wait_to_start_in_namespace() {
  ...
  log_info "Waiting for $description to start and become ready in $namespace namespace for up to $wait_timeout seconds..."
